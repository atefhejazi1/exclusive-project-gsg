          ...
          return (
            <div key={index} className="flex flex-col">
              <div className="relative flex justify-center items-center h-64 bg-[#f5f5f5] rounded-lg group overflow-hidden">
               ...
               {product.isNew &&  <div className="absolute top-2 left-2 p-1 rounded bg-green-400  text-white">
                  New
                </div>}

                {/* زر Add to Cart */}
                <button className="absolute cursor-pointer bottom-0 translate-y-full group-hover:translate-y-0 bg-black w-full text-white py-2 px-4 rounded transition-transform">
                  Add to Cart
                </button>
